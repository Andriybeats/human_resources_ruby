      ...
      describe 'creates department' do
        ...
        context '(invalid data)' do
          it 'does not create new department' do
            invalid_data = attributes_for :department, title: '', status: 'wip'
      ...
      describe 'updates department' do
        context '(valid data)' do
          let(:valid_department) do
            attributes_for :department, title: 'new',
          ...
          it 'updates department' do
            ...
            expect(department.reload.title).to eq('new')
          end
        end

        context '(invalid data)' do
          it 'does not update department' do
            invalid_department = attributes_for :department, title: '', status: 'wip'
